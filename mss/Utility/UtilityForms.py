...
class SelectUserForm(FlaskForm):
    client_select = QuerySelectField(query_factory=lambda: Client.query, allow_blank=False)
...
class SelectMeetingForm(FlaskForm):
...
class SelectMeetingByDayForm(FlaskForm):
...
class SelectMeetingByRoomForm(FlaskForm):
    select_room = QuerySelectField('Select Room:', query_factory=lambda: Room.query, allow_blank=False)
    submit = SubmitField('Submit')



# Form to get a selected client
class SelectMeetingByPersonForm(FlaskForm):
    select_person = QuerySelectField(query_factory=lambda: Client.query, allow_blank=False)
    submit = SubmitField('Submit')



# Form to get two given points in time
class SelectMeetingByTimeForm(FlaskForm):
